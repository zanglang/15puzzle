...
/**
 * Node for handling minimax trees. Max and min are alternating going down the
 * search tree.
 */
public class MiniMaxNode extends Node {

	public static int MAXDEPTH = 999; // the maximum depth that minimax will
										// search, set it for a specific search
										// using the minimaxSearch method

	public MiniMaxNode(MiniMaxState state) {
		super(state);
	}

	public MiniMaxNode(MiniMaxState state, MiniMaxNode parent, Action action,
			double cost) {

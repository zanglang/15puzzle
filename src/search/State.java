...
/**
 * The State interface. Implement this to search for goal states.
 */
public interface State {
	...
	/**
	 * Generates all possible successor actions and respective states that
	 ...
	 * 
	 * @param action
	 *            the action that takes us from this state, must be a legal
	 *            action
	 * @return the cost (non-negative for all legal moves, negative for illegal
	 *         moves)
	 */
